...
ethnicity_dict = {"Ethnicity1": 0, "Ethnicity2": 1, "Ethnicity3": 2}  # Map categories to numbers
...
country_dict = {"Country1": 25, "Country2": 1, "Country3": 2}  # Update with actual mapping
country_of_res = country_dict.get(country_of_res, 0)  # Default to 0
result = st.selectbox("Result (Target Variable for Prediction)", [0, 1])
...
age_group_dict = {"Group1": 0, "Group2": 2, "Group3": 2}  # Update with actual mapping
